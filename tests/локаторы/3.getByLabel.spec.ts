...
test.describe('Базовые тесты для getByLabel()', () => {
  ...
  test('Найти текстовое поле по label', async ({ page }) => {
    const username = page.getByLabel('Имя пользователя'); // TODO(student): замените на корректный локатор
  ...
  test('Найти email поле по label', async ({ page }) => {
    const email = page.getByLabel('Электронная почта'); // TODO(student): замените на корректный локатор
...
test.describe('Тесты для чекбоксов и радиокнопок', () => {
  ...
  test('Работа с чекбоксами', async ({ page }) => {
    const musicCheckbox = page.getByLabel('Музыка'); // TODO(student): замените на корректный локатор
